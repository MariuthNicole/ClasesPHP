        ...
        <div class="card-body">
            <?php
                if (isset($_GET['confirm'])) {
                    ...
                    if ($_GET['confirm'] === "0") {
                        echo '<div class="alert alert-danger" role="alert"> Los Datos no Han Sido ingresados </div>';
                    }
                    if ($_GET['confirm'] === "1") {
                        echo '<div class="alert alert-success" role="alert"> Dato ingresado correctamente </div>';
                    }
                    if ($_GET['confirm'] === "2") {
                        echo '<div class="alert alert-warning" role="alert"> Uno o mas campos estan vacios </div>';
                    }
                    //if ($_GET['confirm'] === "3")
                }
